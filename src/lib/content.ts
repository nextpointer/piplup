export const heroline = "Ready, Set, Quiz!";
export const subHeroLine =
  "Challenge yourself, create quizzes, and have fun with quizzes on every topic.";
...
export const quizData = [
  {
    ...
    about:
      "A beginner-friendly quiz to test your knowledge of TypeScript basics.",
    visibility: "public",
  },
  {
    date: "2023-10-05",
    ...
    about:
      "Challenge your understanding of advanced JavaScript topics like closures and promises.",
    visibility: "private",
  },
  {
    date: "2023-10-10",
  ...
  },
  {
    ...
    about:
      "A quiz to evaluate your understanding of Node.js and server-side JavaScript.",
    visibility: "private",
  },
  {
    date: "2023-10-25",
  ...
  },
  {
    ...
    about:
      "A quiz covering best practices in web development, including performance and accessibility.",
    visibility: "public",
  },
];
...
export const PlayQuizData = {
  ...
  Questions: [
    {
      QuestionName:
        "Which property ensures a hash function's output is unpredictable given a known input?",
      Options: [
        {
    ...
    {
      QuestionName:
        "Which hashing algorithm is generally considered more secure against collision attacks?",
      Options: [
        {
          label: "MD5",
          isCorrect: false,
    ...
    {
      QuestionName:
        "What is the primary use of hashing algorithms in security?",
      Options: [
        {
          label: "Encryption",
          isCorrect: false,
    ...
    {
      QuestionName:
        "What is a secret value added to the hashing process to protect against rainbow table attacks, not stored with the password hash?",
      Options: [
        {
          label: "Salt",
          isCorrect: false,
    ...
    {
      QuestionName:
        "What type of attack exploits the mathematics of probability to find collisions in hash functions?",
      Options: [
        {
    ...
    {
      QuestionName:
        "Which of these algorithms is specifically designed for password hashing?",
      Options: [
        {
          label: "SHA-512",
          isCorrect: false,
    ...
    {
      QuestionName:
        'What does it mean when a hashing algorithm is considered "broken"?',
      Options: [
        {
    ...
    {
      QuestionName:
        "What is the best practice when using salts for password hashing?",
      Options: [
        {
    ...
    {
      QuestionName:
        "What is the primary benefit of using SHA algorithms over simpler checksums like CRC32?",
      Options: [
        {
          label: "Data recovery",
          isCorrect: false,
    ...
    {
      QuestionName:
        "Which password hashing algorithm is resistant to hardware attacks?",
      Options: [
        {
          label: "SHA-3",
          isCorrect: false,
    ...
    {
      QuestionName:
        "What is the property of a hashing algorithm where each output bit depends on multiple input bits?",
      Options: [
        {
          label: "Avalanche effect",
          isCorrect: false,
    ...
    {
      QuestionName:
        "In which of the following scenarios is the 'compare-and-swap' mechanism most likely to be used in conjunction with hashing?",
      Options: [
        {
    ...
    {
      QuestionName:
        "Which of the following is the most critical security property for a hash function used in digital signatures?",
      Options: [
        {
